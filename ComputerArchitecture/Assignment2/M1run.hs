...
-- Define names for the outputs from the datapath.
      ...
      (ma,md,cond,ready,a,b,ir,pc,ad,ovfl,r,x,y,p) = datapath_outputs
      ...
      simoutput =
        [
         ...
         string "\n\nControl signals\n  ",
           ...
           string "\n  ",
           string "  ctl_d_ira = ", bit (ctl_d_ira ctlsigs),
           string "  ctl_mul_start = ", bit (ctl_mul_start ctlsigs),
           string "  ctl_r_prod  = ", bit (ctl_r_prod ctlsigs),
...
-- Process a load to the register file
         fmtIf (ctl_rf_ld ctlsigs)
           [string "Register file update: ",
            string "R",
            bindec 1 (mux1w (ctl_d_ira ctlsigs) (field ir 4 4) (field ir 8 4) ),
            string " := ", hex p,
            setStateWs setRfLoad [(mux1w (ctl_d_ira ctlsigs) (field ir 4 4) (field ir 8 4) ), p],
            string "\n"
            ]
           [],
