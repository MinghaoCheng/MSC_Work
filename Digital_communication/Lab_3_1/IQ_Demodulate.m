function demodulated_sig = IQ_Demodulate(input_sig,n_reference_symbols,i_carrier,q_carrier,samples_per_symbol)
    ...
    i_compared = i_compared(1,samples_per_symbol*n_reference_symbols+1:length(i_compared));
    q_compared = q_compared(1,samples_per_symbol*n_reference_symbols+1:length(q_compared));
