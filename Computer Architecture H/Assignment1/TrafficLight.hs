...
counter :: CBit b => b -> [b]
counter reset = [out0, out1, out2, out3]
    where
        ...
        reset_internal = or2 reset (and4 out0 (inv out1) (inv out2) (inv out3))

trafficLight :: CBit b=> b -> (b, b, b)
trafficLight reset = (green, amber, red)
    where
        green = mux1 reset state0 zero
        amber = mux1 reset (or2 state1 state3) zero
        red = mux1 reset state2 zero

        th0 = and4 (inv counter0) (inv counter1) (inv counter2) (inv counter3)      --0000
        th1 = and4 (inv counter0) (inv counter1) counter2 counter3                  --0011
        th2 = and4 (inv counter0) counter1 (inv counter2) (inv counter3)            --0100
        th3 = and4 counter0 (inv counter1) (inv counter2) (inv counter3)            --1000
        ...
        [counter0, counter1, counter2, counter3] = counter reset
